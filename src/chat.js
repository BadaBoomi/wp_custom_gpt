...
(function () {
    ...
    function renderMarkdown(contentText) {
        ...
        var rawHtml = markdown.render(contentText);
    ...
    function createMessageRow(role, contentHtml, timeText, isPending) {
    ...
    function renderMessages(messages) {
        ...
        messages.forEach(function (message) {
            ...
            var contentHtml = renderMarkdown(contentText);

            messageOutput.appendChild(
                createMessageRow(message.role, contentHtml, formatMessageTime(message.created_at), false)
            );
        });
